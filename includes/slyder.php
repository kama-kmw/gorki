      ...
      <div class="swiper-wrapper slider__wrapper">
        <div class="swiper-slide slider__item">
          ...
          <div
            ...
            style="background-image: url(./img/gory/1.jpeg)"
          ></div>
        </div>
        ...
        <div class="swiper-slide slider__item">
          ...
          <div
            class="slider__layer"
            data-swiper-parallax="14%"
            style="background-image: url(./img/gory/3.jpeg)"
          ></div>
        </div>
        ...
        <div class="swiper-slide slider__item">
          <!-- <div class="slider__layer" data-swiper-parallax="48%" style="background-image: url(img/screen-3/layer-back.jpg);"></div>
				...
				<div class="slider__layer" data-swiper-parallax="29%" style="background-image: url(img/screen-3/gribami.png);"></div> -->
          <canvas
            class="particles slider__layer"
          ...
          ></canvas>
          <div
            class="slider__layer slider__layer-1"
            data-swiper-parallax="16%"
            style="background-image: url(./img/gory/2.jpeg)"
          ></div>
        </div>
          ...
          ></canvas>
          <div
            class="slider__layer slider__layer-2"
            data-swiper-parallax="14%"
            style="background-image: url(./img/gory/4.jpeg)"
          ></div>
        </div>
        ...
        <div class="swiper-slide slider__item">
          ...
          ></canvas>
          <div
            class="slider__layer slider__layer-3"
            data-swiper-parallax="14%"
            style="background-image: url(./img/gory/3.jpeg)"
          ></div>
        </div>
        ...
        <div class="swiper-slide slider__item">
          ...
          <div
            class="slider__layer"
            data-swiper-parallax="16%"
            style="background-image: url(/img/dombay.jpg)"
          ></div>
        </div>
      </div>
