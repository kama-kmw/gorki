...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="row mb-5 category-bottom pt-5">
          ...
          <div class="col-lg-5 mt-5 pl-lg-5" data-aos="fade-up" data-aos-delay="200">
            <h5 class='category__desc'>В нашем  высокогорном регионе, Вы обязательно найдете место, которое идеально подойдет для вашего отдыха:</h5>
          </div>
        </div>
        ...
        <div class="row align-items-center speaker" >
          ...
          <div class="col-lg-6 ml-auto category-bottom">
            ...
            <div class="bio pl-lg-5">
              ...
              <p class="mb-4 category__text" data-aos="fade-right" data-aos-delay="400">Джилы-Су — местность на северной стороне Эльбруса с большим количеством термальных источников и водопадов.</p>
        ...
        <div class="row align-items-center speaker">
          ...
          <div class="col-lg-6 ml-auto order-lg-1 category-left">
            <h2 class="mb-4 name category__sub-title" data-aos="fade-left" data-aos-delay="200">Архыз</h2>
            <div class="bio pr-lg-5">
              ...
              <p class="mb-4 category__text" data-aos="fade-left" data-aos-delay="400">Растительность Архызского района очень разнообразна. Здесь насчитывается более 140 видов древесных и кустарниковых пород. В верховьях Кизгыча сохранился уникальный участок пихтового леса. Кизгычские пихты достигают 60 метров высоты, полутора метров в обхвате.</p>
              <span class="text-black text-uppercase text-primary d-block mb-3" data-aos="fade-right" data-aos-delay="300">от 3000 рублей</span>
              <a href="#" class='text-black'>Подробнее</a>
            </div>
          </div>
        </div>
        ...
        <div class="row align-items-center speaker">
          ...
          <div class="col-lg-6 ml-auto order-lg-1 category-bottom">
            <h2 class="text-black mb-4 name category__sub-title" data-aos="fade-left" data-aos-delay="200">Поляна Азау</h2>
            <div class="bio pr-lg-5">
              <!-- <span class="text-black text-uppercase text-primary d-block mb-3" data-aos="fade-left" data-aos-delay="300">Web Designer</span> -->
              <p class="mb-4 category__text" data-aos="fade-left" data-aos-delay="400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus error deleniti dolores necessitatibus eligendi. Nesciunt repellendus ab voluptatibus. Minima architecto impedit eaque molestiae dicta quam. Cum ducimus. Culpa distinctio aperiam</p>
              <span class="text-black text-uppercase text-primary d-block mb-3" data-aos="fade-right" data-aos-delay="300">от 3000 рублей</span>
              <a href="#" class='text-black'>Подробнее</a>
            </div>
          </div>
        ...
        <div class="row align-items-center speaker">
          ...
          <div class="col-lg-6 ml-auto category-bottom">
            <h2 class="mb-4 name category__sub-title" data-aos="fade-right" data-aos-delay="200">Гижгит Актопрак</h2>
            <div class="bio pl-lg-5">
              <!-- <span class="text-uppercase text-primary d-block mb-3" data-aos="fade-right" data-aos-delay="300">Web Designer</span> -->
              <p class="mb-4 category__text" data-aos="fade-right" data-aos-delay="400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus error deleniti dolores necessitatibus eligendi. Nesciunt repellendus ab voluptatibus. Minima architecto impedit eaque molestiae dicta quam. Cum ducimus. Culpa distinctio aperiam</p>
              <span class="text-black text-uppercase text-primary d-block mb-3" data-aos="fade-right" data-aos-delay="300">от 3000 рублей</span>
        ...
        <div class="row align-items-center speaker">
          ...
          <div class="col-lg-6 ml-auto order-lg-1 category-bottom">
            <h2 class="text-black mb-4 name category__sub-title" data-aos="fade-left" data-aos-delay="200">Домбай</h2>
            <div class="bio pr-lg-5">
              <!-- <span class="text-black text-uppercase text-primary d-block mb-3" data-aos="fade-left" data-aos-delay="300">Web Designer</span> -->
              <p class="mb-4 category__text" data-aos="fade-left" data-aos-delay="400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus error deleniti dolores necessitatibus eligendi. Nesciunt repellendus ab voluptatibus. Minima architecto impedit eaque molestiae dicta quam. Cum ducimus. Culpa distinctio aperiam</p>
        ...
        <div class="row align-items-center speaker">
          ...
          <div class="col-lg-6 ml-auto category-bottom">
            <h2 class="mb-4 name category__sub-title" data-aos="fade-right" data-aos-delay="200">Осетия Кармадон</h2>
            <div class="bio pl-lg-5">
              <!-- <span class="text-uppercase text-primary d-block mb-3" data-aos="fade-right" data-aos-delay="300">Web Designer</span> -->
              <p class="mb-4 category__text" data-aos="fade-right" data-aos-delay="400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus error deleniti dolores necessitatibus eligendi. Nesciunt repellendus ab voluptatibus. Minima architecto impedit eaque molestiae dicta quam. Cum ducimus. Culpa distinctio aperiam</p>
              <span class="text-black text-uppercase text-primary d-block mb-3" data-aos="fade-right" data-aos-delay="300">от 3000 рублей</span>
        ...
        <div class="row align-items-center speaker">
          ...
          <div class="col-lg-6 ml-auto order-lg-1 category-bottom">
            <h2 class="text-black mb-4 name category__sub-title" data-aos="fade-left" data-aos-delay="200">Осетия Дигория</h2>
            <div class="bio pr-lg-5">
              <!-- <span class="text-black text-uppercase text-primary d-block mb-3" data-aos="fade-left" data-aos-delay="300">Web Designer</span> -->
              <p class="mb-4 category__text" data-aos="fade-left" data-aos-delay="400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus error deleniti dolores necessitatibus eligendi. Nesciunt repellendus ab voluptatibus. Minima architecto impedit eaque molestiae dicta quam. Cum ducimus. Culpa distinctio aperiam</p>
              <span class="text-black text-uppercase text-primary d-block mb-3" data-aos="fade-right" data-aos-delay="300">от 3000 рублей</span>
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-lg-6 mt-5 pl-lg-5" data-aos="fade-up" data-aos-delay="100">
            <p class='category__text category-bottom-x4' >Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus error deleniti dolores necessitatibus eligendi. Nesciunt repellendus ab voluptatibus.</p>
          </div>
        </div>
    ...
    <!-- <script type="module" src="js/slyder.js"></script> -->
